...
lazy val cli =
  project
    ...
    .settings(
      ...
      libraryDependencies += "dev.zio"                    %% "zio"                        % "1.0.0-RC21",
      libraryDependencies += "dev.zio"                    %% "zio-test"                   % "1.0.0-RC21" % "test",
      libraryDependencies += "dev.zio"                    %% "zio-test-sbt"               % "1.0.0-RC21" % "test",
